...
if __name__ == "__main__":
    ...
    data_filtered = data_filtered.sample(n=10000)
    ...
    data_cleaning["v9"].replace( {1: 0.35355,2: 0}, inplace=True)
    data_cleaning["v51"].replace({1: 0.35355,2: 0}, inplace=True)
    data_cleaning["v57"].replace({1: 0.35355,2: 0}, inplace=True)
    data_cleaning["v58"].replace({1: 0.35355,2: 0}, inplace=True)
    data_cleaning["v59"].replace({1: 0.35355,2: 0}, inplace=True)
    data_cleaning["v60"].replace({1: 0.35355,2: 0}, inplace=True)
    data_cleaning["v61"].replace({1: 0.35355,2: 0}, inplace=True)
    data_cleaning["v93"].replace({1: 0.35355,2: 0}, inplace=True)

    data_normalised = data_cleaning

    normalise_subset = data_normalised[["v6", "v36","v54", "v55", "v63", "v64", "v115", "v134", "v196"]]
    ...
    filename = "data-normalisedwithbinary"
